		...
		local group = {
			...
			args = {
				...
				hidespelltext = {
					order = 4,
					type = 'toggle',
					name = L['Hide Spell Text'],
					desc = L['Hide Castbar Spell text. Useful if your power height is very low or if you use power offset.'],
					get = function(info) return E.db.CBO[unit].hidespelltext end,
					set = function(info, value) E.db.CBO[unit].hidespelltext = value; updateFunc(CBO, unit); end,
					disabled = function() return not E.db.CBO[unit].overlay end,
				},
				hidetimetext = {
					order = 4,
					...
					desc = L['Hide Castbar Time text. Useful if your power height is very low or if you use power offset.'],
					get = function(info) return E.db.CBO[unit].hidetimetext end,
					set = function(info, value) E.db.CBO[unit].hidetimetext = value; updateFunc(CBO, unit); end,
					disabled = function() return not E.db.CBO[unit].overlay end,
				},
				spacer1 = {
					order = 6,
				...
				xOffsetText = {
					...
					disabled = function() return (not E.db.CBO[unit].overlay or E.db.CBO[unit].hidespelltext) end,
				},
				yOffsetText = {
					order = 8,
					type = 'range',
					name = L['Spell yOffset'],
				...
				xOffsetTime = {
					...
					min = -100, max = 100, step = 1,
					disabled = function() return (not E.db.CBO[unit].overlay or E.db.CBO[unit].hidetimetext) end,
				},
				yOffsetTime = {
					order = 11,
					type = 'range',
